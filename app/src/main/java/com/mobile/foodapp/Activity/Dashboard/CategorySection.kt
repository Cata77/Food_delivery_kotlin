...
import com.mobile.foodapp.Activity.ItemsList.ItemsListActivity
import com.mobile.foodapp.Domain.CategoryModdel
import com.mobile.foodapp.R

@Composable
fun CategorySection(categories: SnapshotStateList<CategoryModdel>, showCategoryLoading: Boolean) {
    Text(
...
@Composable
fun CategoryItem(category: CategoryModdel, modifier: Modifier = Modifier, onItemClick: () -> Unit) {
    Column(
        modifier = modifier
            .fillMaxWidth()
            .background(
